...
export default function StatisticOverview() {
  ...
  const [orderStatistics, setOrderStatistics] = useState<OrderStatusStatistics>(
    StatisticService.getStatusStatistik([])
  );
    ...
    <Segment>
      ...
      <Grid>
            ...
            <Statistic.Group color={"blue"} size={"small"} widths={5}>
              ...
              <Statistic>
                <Statistic.Value>
                  ...
                  {orderStatistics.orderBillRecieved}
                </Statistic.Value>
              ...
              <Statistic>
                <Statistic.Value>
                  ...
                  {orderStatistics.paymentRecieved}
                </Statistic.Value>
        ...
        <Grid.Row>
          <Grid.Column width={16} textAlign={"center"}>
            <h1>
              <Dropdown fluid selection options={options} value={type} onChange={updateValue} />
            </h1>
          </Grid.Column>
        </Grid.Row>
        <Grid.Row>
          <Grid.Column width={16} textAlign={"center"}>
            <Statistic.Group color={"blue"} size={"small"} widths={2}>
              <Statistic>
                <Statistic.Value>
                  {type === "paid"
                    ? totalOpenBills[0] && totalOpenBills[0].paidCount
                    : totalOpenBills[0] && totalOpenBills[0].billedCount}
                </Statistic.Value>
              ...
              <Statistic>
                <Statistic.Value>
                  {type === "paid"
                    ? totalOpenBills[0] &&
                      totalOpenBills[0].paid.toLocaleString("de", {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
                      })
                    : totalOpenBills[0] &&
                      totalOpenBills[0].billed.toLocaleString("de", {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
                      })}
                </Statistic.Value>
              ...
              <ResponsiveContainer>
                ...
                >
                  ...
                  <Bar
                    dataKey={type}
                    fill="#229ad6"
                    name={type === "paid" ? "Umsatz in EUR" : "offene Rechnugnen in EUR"}
                  />
                </BarChart>
              </ResponsiveContainer>
            </div>
